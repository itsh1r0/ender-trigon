...
public class EnderTrigonItems
{
	...
	public static final RegistryObject<Item> BABY_DRAGON_EGG = ITEMS.register("baby_dragon_egg", () -> new BlockItem(EnderTrigonBlocks.BABY_DRAGON_EGG.get(), new Item.Properties().rarity(Rarity.EPIC)));
	public static final RegistryObject<Item> DRAGON_HORN = ITEMS.register("dragon_horn", () -> new DragonHornItem(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).fireResistant(), EnderTrigonInstrumentTags.DRAGON_HORN));
